...
<div className="accordion accordion-flush" id="accordionFlushExample" style={{width:"100%",display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center"}}>
  ...
  <li> › Technologies Used: Js,NodeJS,ExpressJS,Mongoose,MngoDB Atlas(database).</li>
        ...
        <br/>
      <a href='https://mediabook-frontend.vercel.app/'><code>live site link</code></a>
